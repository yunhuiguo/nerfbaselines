...
RobustGaussiansMethodSpec: MethodSpec = {
    "method_class": "robustgaussians.method:RobustGaussians",
    "conda": {
        "environment_name": "robust-gaussians",
        "python_version": "3.11",
        "install_script": r"""
git clone https://github.com/yunhuiguo/RobustGaussians.git
cd RobustGaussians
...
"""
    ...
    "metadata": {
        "name": "RobustGaussians",
        "description": "RobustGaussians adopts 3DGS to handle appearance changes and transient objects. After fixing appearance, it can be baked back into 3DGS.",
        "paper_title": "RobustGaussians: 3D Gaussian Splatting in the Wild",
...
try:
    ...
    register(RobustGaussiansMethodSpec)
except ImportError:
    pass
